...
the budget, while error paths that bail out leave it alone. A silent
hang (no cycle for 15 minutes) raises an error and forces a cycle
through the reconciler tick.
