...
async def trigger_door_change(self, event) -> None:
    ...
    was_open = self.kernel_state.door.effective_open
...
async def _settle_door_region(self, was_open: bool) -> None:
    ...
    if was_open != self.kernel_state.door.effective_open:
        ...
        while True:
            ...
            try:
                if queued is not None:
                    await _settle_door_region(self, was_open=queued)
