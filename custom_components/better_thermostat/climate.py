...
from .const import (
	ATTR_STATE_CALL_FOR_HEAT, ATTR_STATE_DAY_SET_TEMP, ATTR_STATE_LAST_CHANGE, ATTR_STATE_NIGHT_MODE, ATTR_STATE_WINDOW_OPEN, CONF_HEATER, CONF_LOCAL_CALIBRATION,
	...
	async_add_devices(
		[
			BetterThermostat(
				...
				entry.data[CONF_OUTDOOR_SENSOR],
