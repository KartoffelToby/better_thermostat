...
def step(
    ...
    This keeps the legacy semantics: any unavailable optional sensor is
    annunciated as degradation. The ladder rung itself is advanced by
    :func:`step_ladder` from the control-law-relevant capabilities.
    """
