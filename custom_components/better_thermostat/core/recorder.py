...
type _Recordable = Json | datetime | dict[str, "_Recordable"] | list["_Recordable"]
...
def snapshot_from_dict(data: dict[str, Json]) -> WorldSnapshot:
    ...
    return WorldSnapshot(
        ...
        window_open=_bool_or_none(data["window_open"]),
        ...
        startup_running=_bool_of(data["startup_running"]),
        in_maintenance=_bool_of(data["in_maintenance"]),
        ignore_states=_bool_of(data["ignore_states"]),
        degraded=_bool_of(data["degraded"]),
