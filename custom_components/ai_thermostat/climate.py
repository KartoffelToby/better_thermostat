        ...
        async with self._temp_lock:
            if None not in (
                ...
                try:
                    ...
                    _LOGGER.debug(
                        "ai_thermostat triggerd, States > Window open: %s | Night mode: % | Mode: %s | Setted: %s | hasmode: %s | Calibration: %s - send: %s | settemp: %s | curtemp: %s | Model: %s | Calibration type: %s | Winter: %s | TRV: %s",
                        self.window_open,
                        self.night_status,
                        converted_hvac_mode,
                        self._hvac_mode,
